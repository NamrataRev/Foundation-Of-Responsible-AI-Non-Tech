...
The student reads the chatbot's answer, clicks every citation, verifies each claim against the chunk, and only then adds the information to their revision notes. The chatbot output does not go directly into revision material without human review.
