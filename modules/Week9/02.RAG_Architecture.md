...
Look carefully at what happened with all questions:

**Question 1 — "where is eiffel tower?"**
The assistant said: *"The lecture notes provided do not contain information about the location of the Eiffel Tower. Therefore, I cannot answer this question based on the available material."*

This is RAG working correctly. The uploaded files are Python basics notes — eiffel tower is not in them. Instead of guessing, the assistant refused and told the student what the notes do cover. This is **grounding in action**.

**Question 2 — "What is Tupple?"**
...
Click on any citation number in the answer — for example `[4]`.
 ...
 <img src="../images/Verify_a_Citation.png" width="600" height="600">


A popup shows:
- **The source file name** — `3-2.Tuples.md`
...
When asked about the Eiffel Tower and capital of India — which were not in the uploaded files — the assistant correctly said it did not have enough information. A plain LLM would have answered from general knowledge. RAG constrained the answer to the uploaded documents.
