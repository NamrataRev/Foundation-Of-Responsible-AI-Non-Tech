...
## Overview - Why Reflection Matters
...
## Self-Critique — Asking the Model to Challenge Its Own Answer

Reflection asks the model to check its output against a checklist. **Self-critique** goes one step further — it asks the model to actively argue against its own answer, looking for reasons it might be wrong.

**Think of it like a devil's advocate exercise.** In a business meeting, someone proposes a plan. A good team does not just ask "is this correct?" — they ask "what could go wrong? What are we missing? What would someone argue against this?" That adversarial questioning often surfaces problems that a straightforward review missed.

Self-critique works the same way. Instead of asking "is this response good?" — you ask the model to actively try to find flaws in it.

**Without self-critique — Aria's response after standard reflection:**

```
Aria's reflected response: "You are eligible for a full refund. The 
cash portion returns to your original payment method and the voucher 
portion reinstates as store credit. Please share your order number."
```

Standard reflection confirmed this looks complete and correct. But is it actually correct?

**With self-critique — Aria challenges her own answer:**

```
Self-critique instruction: "Before finalising your response, argue 
against it. What could be wrong or incomplete about your answer? 
What might the customer push back on? What edge case might your 
response not cover?"

Aria's self-critique:
- "I said 'full refund' — but I never confirmed the order is within 
  the 30-day return window. What if it is not? My statement could be 
  wrong."
- "I assumed both items are eligible — but I do not know if they are 
  in original packaging, which is a condition for returns. I have made 
  an assumption the customer may not meet."
- "The customer may not know what 'store credit' means in practice — 
  can it be used immediately? Does it expire? I did not address this."

Aria's self-critiqued revision: "Based on what you have described, 
you should be eligible for a refund — but I want to confirm a couple 
of things first to make sure I give you accurate information. Could 
you share your order number and confirm the items are in their 
original packaging? Once I check the return window, I can confirm 
the exact amounts and explain how the store credit portion works."
```

The self-critique produced a more honest, more careful answer — one that does not make promises the system cannot yet verify.

### Self-Critique vs Reflection — The Key Difference

| | Reflection | Self-Critique |
|---|---|---|
| **Question asked** | "Does my response meet these criteria?" | "What could be wrong with my response?" |
| **Stance** | Evaluative — checking against a checklist | Adversarial — actively looking for flaws |
| **Best for** | Catching missing items, format errors, tone | Catching false assumptions, overconfident claims, edge cases |
| **Output** | Revised response that meets the criteria | More cautious, more honest response that acknowledges uncertainty |

**When to use self-critique:**
- When the AI's response makes a definitive claim that has not been verified against a source
- When the query involves eligibility decisions that depend on conditions the model does not know for certain
- When overconfidence in an incorrect answer would cause more harm than saying "let me check first"

**For ShopTech:** self-critique is most valuable for warranty eligibility and refund eligibility responses — the two areas where Aria is most likely to make confident claims she cannot actually verify without the order record.

**Adding self-critique to the system prompt:**

```
Before finalising any response that confirms eligibility for a 
refund or warranty claim, challenge your own answer. Ask: 
- What conditions am I assuming that I have not confirmed?
- What could the customer push back on?
- Am I making a promise I cannot verify without the order record?

If you identify an unverified assumption, revise your response to 
acknowledge it and ask for the information you need before confirming.
```
...
- **Self-critique** goes further — it asks the model to actively argue against its own answer, surfacing false assumptions, overconfident claims, and unverified eligibility decisions
- Reflection asks "does my response meet these criteria?" Self-critique asks "what could be wrong with my response?"
...
- Self-critique reliably improves **claim accuracy and honesty** — catching overconfident answers before they reach the customer
- Neither reflection nor self-critique reliably catches **factual hallucinations** — use grounding for factual accuracy
- Reflection and self-critique criteria must be **specific and checkable** — vague criteria produce vague results
