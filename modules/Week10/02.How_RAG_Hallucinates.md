...
```text
Student: "Where is the Eiffel Tower?"

Claude (no RAG): "The Eiffel Tower is located in Paris, France, on the Champ de Mars
near the Seine River. It was built in 1889 for the World's Fair."
...
Claude (with RAG): "The Eiffel Tower is located in Paris [Source 1].
It was built in 1889 for the World's Fair [Source 1].
It stands 330 metres tall [Source 1]."

Problem: Source 1 is a Python notes file — it says nothing about
the Eiffel Tower. The citations are real. The claims they supposedly
support are not — they came entirely from training data.
The citation format makes the answer look verified.
```
...
You already saw Pattern 2 handled correctly in the RAG Failure and Recovery topic — Pinecone correctly refused the Eiffel Tower and capital of India questions because the notes only contained Python basics:

![Pinecone playground showing chatbot correctly refusing Eiffel Tower and capital of India questions — not in the uploaded Python notes](../images/w10_02_retrieval_failure.png)
...
Click Source 2: shows Python loops content — completely unrelated to the cited claim.
