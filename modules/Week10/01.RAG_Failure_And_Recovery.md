...
![Pinecone playground showing chatbot correctly refusing to answer about gradient descent — not in the uploaded Python notes — with files panel showing all uploaded Python files](../images/w10_02_retrieval_failure.png.png
