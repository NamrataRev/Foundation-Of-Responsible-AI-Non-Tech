...
A student uploads Python basics notes and asks "What is gradient descent?" — a topic not in the uploaded files. Pinecone searches all documents, finds nothing relevant, and the chatbot correctly refuses rather than guessing. This is actually RAG working correctly — the retrieval stage found no matching content and reported it honestly.
