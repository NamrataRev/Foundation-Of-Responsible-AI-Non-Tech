...
![Pinecone playground showing chatbot correctly refusing to answer about Eiffel Tower and capital of India — not in the uploaded Python notes](../images/w10_02_retrieval_failure.png)
Notice what Pinecone says: "I don't have enough information in the provided lecture notes to answer this question based on the available material. The notes contain material from a BTech AI programme covering Python fundamentals..." — it tells the student exactly what the notes do cover instead of guessing.
...
|---|---|---|
| **Direct concept** | "What is a while loop?" | Tests whether the right chunk is retrieved |
