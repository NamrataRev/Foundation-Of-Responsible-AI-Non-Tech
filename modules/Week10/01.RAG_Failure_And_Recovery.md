...
```text
What the augmented prompt looks like when this fails:

Retrieved chunks sent to Claude:
[Source 1] Precision measures the proportion of correct positive predictions...
[Source 2] Recall in psychology refers to the ability to retrieve memories...
[Source 3] Precision in manufacturing means conforming to exact specifications...
[Source 4] Recall measures the proportion of actual positives correctly identified...
[Source 5] High precision with low recall means the model is conservative...

Question: What is the difference between precision and recall?

What Claude generates:
"Precision refers to accuracy and exactness [Source 3]. In recall,
the mind retrieves stored information [Source 2]. Together they
measure model performance [Source 1]."

The answer blends manufacturing, psychology, and machine learning
because all five chunks were retrieved and Claude could not
distinguish which domain the question was asking about.
```

**How to diagnose augmentation failure:** the answer mixes concepts from different topics or domains. The citations point to real chunks — but the chunks themselves are from the wrong context. The fix is better document organisation — one topic per file — so retrieval returns focused chunks from one domain.
