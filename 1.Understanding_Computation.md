...
```mermaid
flowchart TD
    A[Prompt: The capital of\n India is ___] --> B[Model calculates\nlikelihood scores]
    B --> C1[New Delhi: 91%]
    B --> C2[Delhi: 6%]
    B --> C3[a city: 2%]
    B --> C4[unclear: 1%]
    C1 --> D[Model picks highest\nor samples lower one]
```

This is exactly why asking Claude the same question twice can give you two different j
...
- [AWS: What is Generative AI?](https://aws.amazon.com/generative-ai/)
